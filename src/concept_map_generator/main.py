#!/usr/bin/env python
import sys
from concept_map_generator.crew import ConceptMapGeneratorCrew
...
def replay():
    ...
    """
    try:
        ConceptMapGeneratorCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        ConceptMapGeneratorCrew().crew().test(n_iterations=int(sys.argv[1]), openai_model_name=sys.argv[2], inputs=inputs)
